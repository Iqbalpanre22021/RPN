...
let thirdword = word2[14] + word2[15] + word2[16] ;
...
let secondword4 = secondword3.length;

console.log('Second word: ' + secondword3 + ', with lenght : ' + secondword4);

let thirdword3 = word4.substring(15, 17);

let thirdword4 = thirdword3.length;

console.log('Third word: ' + thirdword3  + ', with lenght : ' + thirdword4);

let fourthword3 = word4.substring(18, 20);

let fourthword4 = thirdword3.length;

console.log('fourth word: ' + fourthword3  + ', with lenght : ' + fourthword4);

let fifthword3 = word4.substring(21, 25);

let fifthword4 = fifthword3.length;

console.log('fifth word: ' + fifthword3  + ', with lenght : ' + fifthword4);